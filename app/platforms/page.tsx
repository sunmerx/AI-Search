...
export const metadata: Metadata = {
  title: "AI 平台导航大全",
  description: "国内外 AI 平台汇总导航：大模型公司、API中转、云平台、Agent/IDE等60+平台，含免费额度/优惠速查。",
  alternates: { canonical: abs("/platforms") },
};
...
const CATEGORIES: { title: string; icon: string; items: Platform[] }[] = [
  {
    title: "大模型公司", icon: "🤖",
    items: [
      ...
      { name: "DeepSeek", url: "https://deepseek.com", free: "免费API额度", how: "注册送500万tokens" },
  ...
  return (
    <>
      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        ...
        <h1 className="text-2xl font-bold dark:text-gray-100 mb-1">🌐 AI 平台导航大全</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
          收录 {total} 个国内外 AI 平台，含免费额度/优惠信息速查
        </p>
